        ...
        {featuredProject && (
          ...
          >
            <TiltCard className="group" maxTilt={3}>
              <div className="grid lg:grid-cols-2 gap-8 p-6 md:p-10 rounded-3xl bg-gradient-to-br from-space-800/80 to-space-800/40 border border-white/5 backdrop-blur-sm">
                {/* Project image */}
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-6">
                    {featuredProject.metrics.map((metric) => (
                      <div
                        key={metric}
                        className="px-4 py-2 bg-space-700/30 rounded-xl text-sm text-gray-300 border border-white/5"
                      >
                        {metric}
                      </div>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {featuredProject.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1.5 text-sm bg-violet-500/10 text-violet-400 rounded-lg border border-violet-500/20"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex gap-4">
                    <MagneticHover strength={20}>
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-white text-space-900 rounded-full font-medium hover:bg-gray-100 transition-colors"
                      >
                    ...
                    {featuredProject.links.view !== '#' && (
                      <MagneticHover strength={20}>
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 text-white rounded-full font-medium hover:bg-white/5 transition-colors"
                        >
